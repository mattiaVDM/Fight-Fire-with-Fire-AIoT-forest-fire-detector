...
rexpected.append(frame)
frame = Frame(2,16,4,15,"Fire3") #birds + fire3
rexpected.append(frame)
frame = Frame(4,16,6,15,"Noise") #crickets
rexpected.append(frame)
frame = Frame(6,16,8,15,"Fire3") #crickets + fire3
rexpected.append(frame)
...
rexpected.append(frame)
frame = Frame(14,16,16,15,"Fire3") #birds + fire3
rexpected.append(frame)
frame = Frame(16,16,18,15,"Noise") #insects
rexpected.append(frame)
frame = Frame(18,16,20,15,"Fire3") #insects + fire3
rexpected.append(frame)
...
rexpected.append(frame)
frame = Frame(26,16,28,15,"Fire2") #birds + fire2
rexpected.append(frame)
frame = Frame(28,16,30,15,"Fire2") #birds + fire2
rexpected.append(frame)
...
rexpected.append(frame)
frame = Frame(40,16,44,15,"Fire2") #insects + fire2
rexpected.append(frame)
frame = Frame(44,16,46,15,"Noise") #wind
rexpected.append(frame)
frame = Frame(46,16,48,15,"Fire1") #birds + fire1
rexpected.append(frame)
frame = Frame(48,16,50,15,"Fire1") #birds + fire1
rexpected.append(frame)
frame = Frame(50,16,54,15,"Noise") #rain
rexpected.append(frame)
frame = Frame(54,16,58,15,"Fire1") #insects + fire1
rexpected.append(frame)
...
def compute_results(data, plotting):
    ...
    if (inf_while_fire-inf_while_fire1)!= 0:
    ...
    results.append(fire3_perc)
    results.append(fire2_perc)
    results.append(fire1_perc) #20
    ...
    results.append(mean_fire_while_fire3)
    results.append(mean_fire_while_fire2)
    results.append(mean_fire_while_fire1) #33
    results.append(auc)
...
def print_results(name, inf, RAM, ROM, from_, to, deltas):
    ...
    print("Accuracy:  " + str(from_[0]) + deltas[0] + " - ENT: " + str(from_[1]) + deltas[1])
    print("Recall:    " + str(from_[2]) + deltas[2] + " - ENT: " + str(from_[3]) + deltas[3])
    print("Precision: " + str(from_[4]) + deltas[4] + " - ENT: " + str(from_[5]) + deltas[5])
    print("F1:        " + str(from_[6]) + deltas[6] + " - ENT: " + str(from_[7]) + deltas[7])
    print("\nOptimal threshold found: " + str(from_[35]) + "    AUC(ROC): " + str(float("{:.3f}".format(from_[34]))))
    print("\nTrue Positives: " + str(from_[8]) + deltas[8] + " - ENT: " +str(from_[9]) +  deltas[9] + ", mean score: " + str(from_[10]) + deltas[10])
    print("False negatives: "+ str(from_[11]) + deltas[11] + "- ENT: " +str(from_[12]) + deltas[12] + ", mean score:" + str(from_[13])+ deltas[13])
